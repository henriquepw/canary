  ...
  onClick = async () => {
    ...
    if (validEmail && validPassword) {
      if (selectedStage) {
        ...
        const validConfirmPassowrd = isEquals(password, confirmPassword);
        ...
        {!this.state.isHider && (
          <View
            style={[
              ...
              {
                position: "absolute",
                marginTop: SCREEN_HEIGHT - styles.logo.height - 32
              }
            ]}
          >
            <Image
        ...
        >
          ...
          >
            <View style={styles.buttomContainer}>
              <TouchableWithoutFeedback
                onPress={() =>
                  !this.isLoading ? this.selectCategory(false) : ""
                }
              >
                <Text
                  style={[styles.textButtom, isSignUp && styles.notSeleteted]}
                >
                  Log in
                </Text>
              </TouchableWithoutFeedback>
              <TouchableWithoutFeedback
                onPress={() =>
                  !this.isLoading ? this.selectCategory(true) : ""
                }
              >
                <Text
                  style={[styles.textButtom, isLogIn && styles.notSeleteted]}
                >
                  Sign up
                </Text>
              </TouchableWithoutFeedback>
            ...
            <View style={styles.inputContainer}>
              {isSignUp && (
                <Input
                  ...
                  errorMessage={!this.state.isNameValid ? "Nome invalido" : ""}
                />
              )}
              <Input
                placeholder="E-mail..."
                ...
                errorMessage={!this.state.isEmailValid ? "E-mal invalido" : ""}
              />
              <Input
                placeholder="Senha..."
                leftIcon={
                ...
                errorMessage={
                  !this.state.isPasswordValid ? "Senhar invalida" : ""
                }
              />
              {isSignUp && (
                <Input
